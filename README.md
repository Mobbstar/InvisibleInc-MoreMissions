...
Alternatively, and much easier, you can download the .rar file containing the most recent full build of the mod, such as MoreMissionsV.0.4.rar, and unzip it into your Mods folder. This version is largely up to date but may not include recent minor updates.
