...
{
	CANCEL = STRINGS.MOREMISSIONS.ABILITIES.MODIFY_ITEM.UPGRADE_OPTIONS.CANCEL,
	COOLDOWN = STRINGS.MOREMISSIONS.ABILITIES.MODIFY_ITEM.UPGRADE_OPTIONS.COOLDOWN,
	CHARGE = STRINGS.MOREMISSIONS.ABILITIES.MODIFY_ITEM.UPGRADE_OPTIONS.CHARGE,
	AMMO = STRINGS.MOREMISSIONS.ABILITIES.MODIFY_ITEM.UPGRADE_OPTIONS.AMMO,
	POWER = STRINGS.MOREMISSIONS.ABILITIES.MODIFY_ITEM.UPGRADE_OPTIONS.POWER,
	SKILL_REQ = STRINGS.MOREMISSIONS.ABILITIES.MODIFY_ITEM.UPGRADE_OPTIONS.SKILL_REQ,
	ARMOR_PIERCE = STRINGS.MOREMISSIONS.ABILITIES.MODIFY_ITEM.UPGRADE_OPTIONS.ARMOR_PIERCE,
	DAMAGE = STRINGS.MOREMISSIONS.ABILITIES.MODIFY_ITEM.UPGRADE_OPTIONS.DAMAGE,
}
