...
local tool_templates =
{
	...
	MM_techexpo_hologrenadeHD = util.extend( commondefs.grenade_template )
	{
		...
		traits = { cooldown = 0, cooldownMax = 2, cover=false, holoProjector=true, disposable = false, agent_filter=true, deploy_cover=true, deploySightblock = true, MM_tech_expo_item = true, MM_tech_expo_nonweapon = true, usesLeft = 3,},	
		abilities = { "recharge","carryable", "throw" },
		value = 600,	
		locator=true,
	},
